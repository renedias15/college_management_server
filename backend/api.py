...
############################################LOGIN$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
@app.route('/api/Teacherlogin', methods=['GET'])
...
@app.route('/api/getAnnouncements', methods=['GET'])
...
@app.route('/api/addAnnouncement', methods=['POST'])
...
@app.route('/api/updateStudent/<int:student_id>', methods=['PUT'])
...
############################LEAVES####################################################################
@app.route('/api/requestLeave/<string:email>', methods=['POST'])
...
@app.route('/api/getLeaveRequests', methods=['GET'])
...
@app.route('/api/approveLeave/<int:leaveId>', methods=['DELETE'])
...
@app.route('/api/rejectLeave/<int:leaveId>', methods=['DELETE'])
...
#################################################################
############################ADmission####################################################################
@app.route('/api/EntranceForm_courses', methods=['GET'])
...
@app.route('/api/enteranceForm', methods=['POST'])
def enterance_form():
    try:
...
@app.route('/api/getEnteranceForms', methods=['GET'])
...
@app.route('/api/getElligibleApplicants', methods=['GET'])
...
@app.route('/api/verifyApplicant/<int:id>/<string:res>', methods=['PUT'])
...
def handler(event, context):
    return serverless.handle_aws_lambda_event(event, context)
###########################
